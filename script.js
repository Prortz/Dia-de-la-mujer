...
// Función para calcular la posición del ratón en el SVG
function oMousePosSVG(e) {
  var p = svg.createSVGPoint();
  p.x = e.touches[0].clientX; // Usamos touches para eventos táctiles en dispositivos móviles
  p.y = e.touches[0].clientY; // Usamos touches para eventos táctiles en dispositivos móviles
  var ctm = svg.getScreenCTM().inverse();
  var p = p.matrixTransform(ctm);
  return p;
}

// Evento para manejar el toque en el SVG
...
// Evento para manejar el fin del toque en el SVG
svg.addEventListener("touchend", e => {
  bool = false;
  previous = {};
});

// Evento para manejar el movimiento en el SVG
